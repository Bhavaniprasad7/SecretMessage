...
document.getElementById("name").addEventListener("keyup", function () {
  ...
  if (value == "emma") {
    console.log("User entered emma");
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/emma.jpg`;
  ...
  if (value == "zendaya") {
    console.log("User entered zendaya");
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/zendaya.jpg`;
    const hoverUrl = "images/love.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
  ...
  if (value == "selena") {
    console.log("User entered selana");
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/selena.png`;
    const hoverUrl = "images/love.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
  ...
  if (value == "ariana") {
    console.log("User entered ariana");
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/ariana.jpeg`;
    const hoverUrl = "images/love.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
  ...
  if (value == "elsa") {
    console.log("User entered elsa");
    canvas.style.display = "";
  }
  if (value == "deepika") {
    console.log("User entered deepika");
  }
});
